  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10 text-slate-700 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-5xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {/* Header */}
        <header className="border-b border-slate-200 bg-slate-50 px-6 py-8 sm:px-10 lg:px-14">
        ...
        {/* Content */}
        <main className="px-6 py-8 sm:px-10 lg:px-14 lg:py-12">
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-[15px] leading-7 text-slate-600">
              <li>Customer name</li>
              <li>Phone number</li>
              <li>Email address</li>
        ...
        {/* Footer */}
        <footer className="border-t border-slate-200 bg-slate-50 px-6 py-5 text-center text-sm text-slate-500 sm:px-10">
